                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div style="color:red;">{{$errors->first('permanent_address')}}</div>
                      ...
                      <div style="color:red;">{{$errors->first('date_of_birth')}}</div>
                          ...
                          <input type="text" class="form-control" required name="qualification" value="{{old('qualification')}}"  placeholder=" Qualification">
                      <div style="color:red;">{{$errors->first('qualification')}}</div>
                          ...
                          <input type="text" class="form-control" required name="note" value="{{old('note')}}"  placeholder="Note">
